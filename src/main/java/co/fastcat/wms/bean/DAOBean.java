...
import co.fastcat.wms.bean.DAOBeanInfo.FieldColumnType;
...
//			logger.debug("f = {}", fct.field);
	...
	private void setFieldData(ResultSet rs, int idx, DBField.Type type, String column) {
		try{
	...
	private void setFieldData(int idx, DBField.Type type, String val) {
		try{
			if(type == DBField.Type.String){
